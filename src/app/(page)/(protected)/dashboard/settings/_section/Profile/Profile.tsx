      ...
      <div className="flex w-full flex-col gap-y-4 px-4">
        ...
        <div className="flex w-full items-center gap-x-4">
          <div className="flex w-full items-center gap-x-4">
            ...
            <span className="w-[150px] rounded-md bg-[#D9D9D970] py-1.5 text-center font-medium">Thirapat</span>
          </div>
          <div className="flex w-full items-center gap-x-4 ">
            <span className="font-bold">Role</span>
            <span className="w-[100px] rounded-md bg-[#D9D9D970] py-1.5 text-center font-medium">User</span>
          </div>
        </div>
      </div>
      <div className="mt-8 flex w-full justify-between px-4">
        <button className="text-sm font-bold">Reset Password</button>
        <button className="rounded-md bg-red-600 px-4 py-1.5 font-bold text-white hover:bg-red-700">Logout</button>
      </div>
    </Card>
  );
};
